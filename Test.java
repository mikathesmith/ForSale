...
public class Test {
    ...
    private static int index30 = -1,index29 = -1,index28 = -1,index27 = -1,index2 = -1, index1 = -1;
    ...
    public static void main(String[] args) {
        ...
        Strategy s = new Strategy(){
                ...
                public Card chooseCard(PlayerRecord p, SaleState s) {
                    ...
                    Collections.sort(myCurrentHand);
                    for (int i = 0 ; i < myCurrentHand.size() ; i++){
        ...
        ArrayList<Player> players = new ArrayList<Player>();
         players.add(new Player("flop" + ((char) ('A')), flop));
            players.add(new Player("R"+ ((char) ('A' )), r));
            players.add(new Player("flop" + ((char) ('B')), flop));
            players.add(new Player("R"+ ((char) ('B' )), r));
            players.add(new Player("R"+ ((char) ('C' )), r));
            players.add(new Player("The Real Estate Agents ", s));
